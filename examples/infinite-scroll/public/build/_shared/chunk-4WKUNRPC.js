    ...
    (function (l, y) {
      ...
      l.createBrowserHistory = function (b) {
        ...
        function B(c, a) {
          ...
          if (
            !f.length ||
            (f.call({ action: m, location: k, retry: e }), false)
          ) {
        ...
        function z(c, a) {
          ...
          var m = l.Action.Replace,
            k = t(c, a);
          (f.length && (f.call({ action: m, location: k, retry: e }), 1)) ||
            ((k = [{ usr: k.state, key: k.key, idx: w }, h(k)]),
            n.replaceState(k[0], "", k[1]),
            A(m));
        }
        function x(c) {
          n.go(c);
        ...
        b === void 0 && (b = {});
        b = b.window;
        var q = b === void 0 ? document.defaultView : b,
          n = q.history,
          v = null;
        q.addEventListener("popstate", function () {
          if (v) f.call(v), (v = null);
          else {
            var c = l.Action.Pop,
              a = g(),
              e = a[0];
      ...
      l.createHashHistory = function (b) {
        function g() {
          var a = F(n.location.hash.substr(1)),
            e = a.pathname,
            m = a.search;
          a = a.hash;
          var k = v.state || {};
        ...
        function z(a, e) {
          ...
          if (
            !c.length ||
            (c.call({ action: k, location: p, retry: m }), false)
          ) {
        ...
        function x(a, e) {
          ...
          (c.length && (c.call({ action: k, location: p, retry: m }), 1)) ||
            ((p = [{ usr: p.state, key: p.key, idx: r }, t(p)]),
            v.replaceState(p[0], "", p[1]),
            B(k));
        }
        function q(a) {
          v.go(a);
        ...
        b === void 0 && (b = {});
        b = b.window;
        var n = b === void 0 ? document.defaultView : b,
          v = n.history,
          u = null;
      ...
      l.createMemoryHistory = function (b) {
        function g(d, f) {
          ...
          return Object.freeze(
            y(
              { pathname: u.pathname, search: "", hash: "" },
        ...
        function h(d, f, c) {
          return (
            !r.length || (r.call({ action: d, location: f, retry: c }), false)
          );
        }
        function t(d, f) {
          v = d;
        ...
        function z(d) {
          var f = Math.min(Math.max(n + d, 0), q.length - 1),
            c = l.Action.Pop,
            a = q[f];
          h(c, a, function () {
            z(d);
        ...
        var q = (b === void 0 ? ["/"] : b).map(function (d) {
            var f = Object.freeze(
              y(
                { pathname: "/", search: "", hash: "", state: null, key: I() },
                typeof d === "string" ? F(d) : d
              )
            );
            C(
          ...
          n = Math.min(Math.max(x == null ? q.length - 1 : x, 0), q.length - 1),
          v = l.Action.Pop,
          u = q[n],
          w = D(),
          r = D();
...
var require_react_router_development = __commonJS({
  "node_modules/react-router/umd/react-router.development.js"(exports, module) {
    ...
    (function (global, factory) {
      typeof exports === "object" && typeof module !== "undefined"
        ? factory(exports, require_react(), require_main())
        : typeof define === "function" && define.amd
        ? define(["exports", "react", "history"], factory)
        : ((global = global || self),
          factory(
            (global.ReactRouter = {}),
            global.React,
      ...
      function Navigate(_ref2) {
        ...
        !useInRouterContext()
          ...
          : void 0;
        warning(
          !React3.useContext(NavigationContext).static,
      ...
      function useHref3(to) {
        ...
        let { hash, pathname, search } = useResolvedPath3(to);
      ...
      function useNavigate3() {
        ...
        let { pathname: locationPathname } = useLocation4();
...
` +
      ...
      function generatePath(path, params) {
        ...
        return path
          .replace(/:(\w+)/g, (_, key) => {
            !(params[key] != null)
              ? invariant2(false, 'Missing ":' + key + '" param')
              : void 0;
            return params[key];
          })
          .replace(/\/*\*$/, _ =>
          ...
          return /* @__PURE__ */ React3.createElement(RouteContext.Provider, {
            children:
              match.route.element !== void 0
                ? match.route.element
                : /* @__PURE__ */ React3.createElement(Outlet2, null),
            value: {
              outlet,
...
var require_react_router_dom_development = __commonJS({
  "node_modules/react-router-dom/umd/react-router-dom.development.js"(
    ...
    (function (global, factory) {
      typeof exports === "object" && typeof module !== "undefined"
        ? factory(exports, require_react(), require_main(), require_main2())
        : typeof define === "function" && define.amd
      ...
      const Link2 = /* @__PURE__ */ React3.forwardRef(function LinkWithRef(
        _ref3,
        ref
      ) {
        let {
      ...
      const NavLink2 = /* @__PURE__ */ React3.forwardRef(
        function NavLinkWithRef(_ref4, ref) {
          let {
        ...
        return React3.useCallback(
          event => {
            if (
              ...
              let replace =
                !!replaceProp ||
                history.createPath(location) === history.createPath(path);
              navigate(to, {
                replace,
                state
              });
      ...
      function useSearchParams2(defaultInit) {
        ...
        let defaultSearchParamsRef = React3.useRef(
      ...
      /* @__PURE__ */ import_react.default.createElement(
        ...
        /* @__PURE__ */ import_react.default.createElement(
          ...
          /* @__PURE__ */ import_react.default.createElement(
            "p",
            null,
            "There was an uncaught exception in your application. Check the browser console and/or server console to inspect the error."
          ),
          /* @__PURE__ */ import_react.default.createElement(
            "p",
            null,
            "If you are the developer, consider adding your own error boundary so users don't see this page when unexpected errors happen in production!"
          ),
          /* @__PURE__ */ import_react.default.createElement(
            "p",
            null,
      ...
      /* @__PURE__ */ import_react.default.createElement(
        ...
        /* @__PURE__ */ import_react.default.createElement(
          ...
          /* @__PURE__ */ import_react.default.createElement(
            "p",
            null,
            "There was an unhandled thrown response in your application."
          ),
          /* @__PURE__ */ import_react.default.createElement(
            "p",
            null,
            "If you are the developer, consider adding your own catch boundary so users don't see this page when unhandled thrown response happen in production!"
          ),
          /* @__PURE__ */ import_react.default.createElement(
            "p",
            null,
...
function createTransitionManager(init) {
  ...
  async function handleActionSubmissionNavigation(
    ...
    if (
      ...
      matches2[matches2.length - 1].route.id.endsWith("/index")
    ) {
  ...
  function abortNormalNavigation() {
    ...
    (_pendingNavigationCon = pendingNavigationController) === null ||
    _pendingNavigationCon === void 0
      ? void 0
      : _pendingNavigationCon.abort();
  }
...
async function callAction(submission, match, signal) {
  if (!match.route.action) {
    throw new Error(
      `Route "${match.route.id}" does not have an action, but you are trying to submit to it. To fix this, please add an \`action\` function to the route`
    );
  }
  try {
...
function createAction(route) {
  if (!route.hasAction) return void 0;
...
// node_modules/@remix-run/react/browser/components.js
var RemixEntryContext = /* @__PURE__ */ import_react3.default.createContext(
  void 0
);
...
function RemixEntry({
  ...
  let clientRoutes = import_react3.default.useMemo(
    () => createClientRoutes(manifest.routes, routeModules, RemixRoute),
    [manifest, routeModules]
  );
  let [clientState, setClientState] = import_react3.default.useState(
  ...
  return /* @__PURE__ */ import_react3.default.createElement(
    ...
    /* @__PURE__ */ import_react3.default.createElement(
      ...
      /* @__PURE__ */ import_react3.default.createElement(
        ...
        /* @__PURE__ */ import_react3.default.createElement(
          import_react_router_dom2.Router,
          {
...
function Routes() {
  ...
  let element =
    (0, import_react_router_dom2.useRoutes)(clientRoutes) ||
    clientRoutes[0].element;
  return element;
}
var RemixRouteContext = /* @__PURE__ */ import_react3.default.createContext(
  void 0
);
...
function usePrefetchBehavior(prefetch, theirElementProps) {
  ...
  let [shouldPrefetch, setShouldPrefetch] =
    import_react3.default.useState(false);
...
var Link = /* @__PURE__ */ import_react3.default.forwardRef(
  ({ to, prefetch = "none", ...props }, forwardedRef) => {
    ...
    return /* @__PURE__ */ import_react3.default.createElement(
      ...
      shouldPrefetch &&
        /* @__PURE__ */ import_react3.default.createElement(PrefetchPageLinks, {
          page: href
        })
    );
  }
...
function Links() {
  ...
  let links = import_react3.default.useMemo(
...
function PrefetchPageLinks({ page, ...dataLinkProps }) {
  let { clientRoutes } = useRemixEntryContext();
  let matches = import_react3.default.useMemo(
...
function RemixBrowser(_props) {
  ...
  let [state, dispatch] = import_react4.default.useReducer(
    (_, update) => update,
    {
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-4WKUNRPC.js.map
